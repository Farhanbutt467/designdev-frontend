      ...
      <div className="container2" ref={containerRef}>
        <div className="pt-[128px] xl:pt-[178px] 2xl:pt-[218px]">
          ...
          <div className="grid gap-y-5 gap-x-[70px] grid-cols-[auto] lg:grid-cols-[auto_1fr] md:ms-[156px] mt-[24px] xl:mt-[44px]">
            <div className="mt-1">
              <span
                className="has_fade_anim pe-[100px] text-[16px] inline-block leading-none uppercase text-text relative"
                data-fade-from="left"
                data-delay=".30"
              >
                {subtitle}
                <span className="absolute w-20 h-[2px] bg-text-3 top-1/2 -translate-y-1/2 end-0" />
              </span>
            </div>
            <p
              className="has_fade_anim max-w-[350px] text-text-3"
              data-fade-from="left"
              data-delay=".45"
            >
              {description}
